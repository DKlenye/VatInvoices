...
using Naftan.VatInvoices.Mnsati.AddNoReference;

namespace Naftan.VatInvoices.Converters
{
    public class InvoiceAddNoReferenceConverter:IConverter<VatInvoice,issuance>
    {
        public VatInvoice To(issuance obj)
        {
            return new VatInvoice
            {
                ...
                DateIssuance = obj.general.dateIssuance,
        ...
        public issuance From(VatInvoice obj)
        {
            return new issuance()
            {
                ...
                provider = obj.ConvertTo<provider>(),
                recipient = obj.ConvertTo<recipient>(),
